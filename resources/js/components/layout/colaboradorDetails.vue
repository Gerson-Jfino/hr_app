...
export default {
    ...
    methods: {
        ...
        try {
            const employe = (await axios.get(`${BASE_URL}colaborador/${id}`)).data
            if (employe.employee) {
                this.employee = employe.employee
            }
            if (employe.personal_data) {
                this.personal_data = employe.personal_data
            }
            if (employe.nivel_academico) {
                this.nivel_academico = employe.nivel_academico
            }
